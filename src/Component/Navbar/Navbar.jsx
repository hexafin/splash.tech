                        ...
                        <div className="container">
                            <div className="row">
                                ...
                                <div className="col-md-6 col-4 sp-navmenu-static">
                                    <button className="navbar-toggler" type="button" onClick={(e)=>toggleNavBar(e)}>
                                    ...
                                    <div className="collapse navbar-collapse sp-menu-toggler justify-content-md-center" id="navbarNavDropdown">
                                        <ul className="navbar-nav text-md-center sp-navbar-nav">
                                            ...
                                            <li className="nav-item">
                                                <Link className="nav-link" to="/" onClick={(e)=>goToFeatures(e)}>Features</Link>
                                            </li>
                                            <li className="nav-item">
                                                <Link className="nav-link" to="/" onClick={(e)=>goToContact(e)}>Contact us</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div>

...
class Landing extends Component {
    state = {
        ...
        subjectOptions: ["Feedback", "Partnership", "Press", "Get involved"]
    };
    render() {
        return (
            <React.Fragment>
                <div className="sp-welcome">
                    ...
                    <a href="https://itunes.apple.com/app/id1398891726">
                        <img
                            src={require("../../assets/images/appstore.png")}
                            className="sp-welcome-appstore"
                        />
                    </a>
                    <img
                        src={require("../../assets/images/brian.png")}
                        className="sp-floating-person sp-person-1"
                    />
                    <img
                        src={require("../../assets/images/jane.png")}
                        className="sp-floating-person sp-person-2"
                    />
                    <img
                            ...
                            <div className="col-lg-6 offset-lg-3 col-md-10 offset-md-1">
                                <div className="sp-getintouch-innerblock">
                                    ...
                                    >
                                        ...
                                        <div className="form-group">
                                            <div
                                                className="sp-drop-box"
                                                id="sp-subject-dropdown"
                                            >
                                                <div className="sp-select-sub">
                                                    <label>Subject</label>
                                                    <div
                                                        className="sp-dropdown-box"
                                                        onMouseEnter={() =>
                                                            this.showDropDown()
                                                        }
                                                        onMouseLeave={() =>
                            ...
                            <div className="col-sm-12">
                                <div className="sp-social-icon">
                                    <ul>
                                        <li>
                                            <a
                                                href="https://twitter.com/splashwallet"
                                                target="_blank"
                                        ...
                                        <li>
                                            <a
                                                href="https://www.facebook.com/SplashWalletTech/"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                <i className="sp-fb" />
                                        ...
                                        <li>
                                            <a
                                                href="https://www.linkedin.com/company/splash-tech/"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                <i className="sp-linkedin" />
                                                <span>Linkedin</span>
                                            </a>
                                        </li>
                                        {/*<li>
                                        ...
                                        <li>
                                            <a
                                                href="https://medium.com/splash-wallet"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                <i className="sp-medium" />
                                                <span>Medium</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a
                                                href="https://www.crunchbase.com/organization/splash-tech"
                                                target="_blank"
                                                rel="noopener noreferrer"
                                            >
                                                <i className="sp-crunchbase" />
                ...
                if (option && option !== this.state.selectedSubject) {
                    return (
                        <li key={i}>
                            <button
                                type="button"
                                onClick={e => this.selectSubject(e, option)}
                            >
                                {option}
                            </button>
                        </li>
    ...
    contactUs(e) {
        ...
        if (data.name && data.email && data.subject && data.text) {
            ContactUsService.sendMessage(data)
                .then(() => {
                    CommanService.showToaster(
                        "success",
                        "Thanks for your interest in Splash! We’ll keep you in the loop."
                    );
                })
                .catch(e => {
    ...
    submitKeepMeUpdate(e) {
        ...
        NewsLetterService.subscribeList(body)
            .then(res => {
                CommanService.showToaster(
                    "success",
                    "Thanks for your interest in Splash! We’ll keep you in the loop."
